...
<div class="top">
    <div class="container">
        <nav class="col-md-12 nav">
            ...
            <div class="boutonMenu col-md-4">
                <div class="titreMenu">Gestion des oeuvres et auteurs</div>
                <a class="SousMenu" href="Oeuvre_show.php">Gestion des oeuvres et exemplaires</a>
                <a class="SousMenu" href="Auteur_show.php">Gestion des auteurs</a>
            </div>
            <div class="boutonMenu col-md-4">
